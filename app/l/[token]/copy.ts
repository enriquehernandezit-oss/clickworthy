...
export const funnelCopy = {
  en: {
    ...
    guarantee: "Don't love them? We'll keep re-editing until you do — at no extra cost. Delivered within 5 business days.",
  ...
  es: {
    ...
    guarantee: "¿No te encantan? Seguimos editándolas hasta que sí — sin costo adicional. Entrega en 5 días hábiles.",
