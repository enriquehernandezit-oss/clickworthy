    ...
    <div className="rounded-xl border border-stone-200 bg-white p-5">
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-3">
          <div>
            <label className="text-xs font-medium text-stone-500">Subject lines (rotates across 3, one per restaurant)</label>
            ...
            <div className="flex gap-1">
              {[0, 1, 2].map((i) => (
                <button
                  ...
                  className={`rounded px-2 py-0.5 text-[11px] font-semibold ${subjectIdx === i ? "bg-stone-900 text-white" : "bg-stone-100 text-stone-600"}`}
                >
                  {i + 1}
                </button>
              ))}
